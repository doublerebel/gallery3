(function ($) {
  ...
  $.fn.gallery_context_menu = function() {
    if ($(".g-context-menu li").length) {
      var $menuItems = $(".g-context-menu").hover(
        function() {
      ...
      $menuItems.find('.i-icon-rotate-cw, .i-icon-rotate-ccw').galleryAjaxRotateHandler();
      $menuItems.find('.ui-icon-star').galleryAjaxSetAlbumCoverHandler();
    }
  };
